...
Once a solution has been found, the program will print out a grid of 0's with 1's on it.
The 1's will represent where a queen should be, and the 0's will represent an empty space. 
